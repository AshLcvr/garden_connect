 ...
 */
final class Version20220610101537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD mesure_id INT NOT NULL');
        $this->addSql('ALTER TABLE annonce ADD CONSTRAINT FK_F65593E543AB22FA FOREIGN KEY (mesure_id) REFERENCES mesure (id)');
        $this->addSql('CREATE INDEX IDX_F65593E543AB22FA ON annonce (mesure_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F65593E543AB22FA ON annonce');
        $this->addSql('ALTER TABLE annonce DROP mesure_id');
    }
}
